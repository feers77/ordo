...
Necesitamos un stack para un ERP API-first operado por agentes, con paridad de comportamiento con Odoo Community y localizaciones fiscales complejas. El kernel debe generar SQL desde un lenguaje de dominios y servir OpenAPI introspectable.

## Opciones consideradas

1. **Python 3.12 + FastAPI + SQLAlchemy 2.0 + Postgres 17** — semántica cercana a Odoo, ecosistema fiscal maduro, OpenAPI nativo; menor rendimiento bruto.
...
- Positivas: velocidad de desarrollo, facilidad para reimplementar comportamiento Odoo, generación dinámica de schemas.
